                  ...
                  $r2=mysqli_query($conn,$Q2);
                     ...
                     {?>
                        <tr <?php if($row1['msg']=="Off Route"){ ?>  style="color: red; font-weight: bold;"<?php } else {?> style="color: #228b22; font-weight: bold;"<?php }?>>
                            ...
                            <td > <div class="flex-parent jc-center"><form method="POST" action="view.php">
                            ...
                            <form method="POST" action=update.php>
                                <input type="hidden" name="dev" value="<?php echo $dev;?>"><button title="UPDATE DEVICE" data-toggle="tooltip" type ="submit"> <span CLASS ="fa fa-pencil"></span></button></form>&nbsp;
                            <form method="POST" action=record.php>
                                <input type="hidden" name="dev" value="<?php echo $dev;?>"><button title="DEVICE RECORDS" data-toggle="tooltip" type ="submit"> <span CLASS ="fa fa-file"></span></button></form>
